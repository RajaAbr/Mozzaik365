  ...
  describe("MemeFeedPage", () => {
    ...
    it("should create new comment display it with other comments", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByTestId("add-meme-comment-to-dummy_meme_id_1")
        ).toBeInTheDocument();
        const addCommentInput = screen.getByPlaceholderText(
          "Type your comment here..."
        );

        fireEvent.change(addCommentInput, { target: { value: "Hello World" } });
      });
    });
  });
});
