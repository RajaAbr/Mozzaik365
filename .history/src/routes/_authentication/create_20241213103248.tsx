...
function CreateMemePage() {
  ...
  const { mutate } = useMutation({
    mutationFn: async () => {
      ...
      memeData.append("picture", picture.file);
      memeData.append("description", description);

      texts.forEach((text, index) => {
        memeData.append(`Texts[${index}][Content]`, text.Content);
        memeData.append(`Texts[${index}][X]`, text.X.toString());
        memeData.append(`Texts[${index}][Y]`, text.Y.toString());
      });

      memeData.append("texts", JSON.stringify(mocktexts));
