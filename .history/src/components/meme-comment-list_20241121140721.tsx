...
export const MemeCommentList: React.FC<MemeEditorProps> = () => { <LinkBox as={Box} py={2} borderBottom="1px solid black">

return (<VStack key={meme.id} p={4} width="full" align="stretch"></VStack><Flex justifyContent="space-between" alignItems="center">
