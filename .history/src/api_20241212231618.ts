import { CreateCommentResponse, GetMemeCommentsResponse, GetMemesResponse, GetUserByIdResponse, LoginResponse } from "./types";
 ...
 * @param content
 */
export async function createMeme(token: string, memeDate: string): Promise<CreateCommentResponse> {
